<?php
/**
 * Plugin Name: CartRenew – WooCommerce Abandoned Cart Recovery via WhatsApp
 * Plugin URI:  https://www.cartrenew.com/en/woocommerce
 * Description: Every day, 70% of WooCommerce carts are abandoned. Email recovery gets ~20% open rates. WhatsApp gets 90%+. CartRenew automates the entire recovery flow.
 * Version:     0.1.3
 * Author:      CartRenew
...
define( 'CARTRENEW_WC_VERSION', '0.1.3' );
