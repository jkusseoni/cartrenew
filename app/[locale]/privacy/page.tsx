      ...
      <div className="max-w-4xl mx-auto space-y-8 bg-neutral-900/20 border border-neutral-900 p-8 sm:p-12 rounded-2xl backdrop-blur-md">
        ...
        <div className="space-y-6 text-sm sm:text-base leading-relaxed">
          ...
          <section className="space-y-2">
            ...
            <p>If you have any questions regarding this Privacy Policy, please reach out to our administration team directly at: <a href="mailto:contact@cartrenew.com" className="text-blue-500 hover:underline font-mono">contact@cartrenew.com</a>.</p>
          </section>
        </div>
